...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   BinarySearchTree_implementation.hpp                :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: lperson- <lperson-@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/02/28 10:21:51 by lperson-          #+#    #+#             */
/*   Updated: 2022/04/12 13:03:08 by lperson-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#ifndef BINARY_SEARCH_TREE_IMPLEMENTATION_HPP

# define BINARY_SEARCH_TREE_IMPLEMENTATION_HPP
...
namespace ft
{
    ...
    */
    ...
    template <class T, class Compare, class Alloc>
    typename BinarySearchTree<T, Compare, Alloc>::size_type
    BinarySearchTree<T, Compare, Alloc>::erase(const_reference value)
    {
